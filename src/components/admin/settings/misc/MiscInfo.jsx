                      ...
                      <SimpleGrid columns={{ base: 2 }} rowGap={6} w="full">
                        ...
                        <GridItem colSpan={2}>
                          <NonRequiredTextInput
                            ...
                            touched={touched?.hostUrl}
                          />
                        </GridItem>

                        <GridItem colSpan={{ base: 2 }}>
                          <AdminGeneralImageUpload
                            title={'Embeded Discord Preview Reward Image'}
                            error={errors?.pendingRewardImageUrl}
                            touched={touched?.pendingRewardImageUrl}
                            uploaded={values?.pendingRewardImageUrl}
                            onConfirmUpload={(imageUrl) => {
                              // dont clear the field on cancel, no way to re-upload old file
                              setFieldValue('pendingRewardImageUrl', imageUrl)
                            }}
